...
export default function ThirdSection(){
    ...
    return (
        <div className={`flex flex-col lg:px-80   justify-center items-center   ${theme === "dark" ? "bg-black text-white" : "text-black bg-white"}`}>
            ...
            <p className="text-justify text-sm lg:text-lg p-5">HoldOnPlay, a part of Believe, is the leading global platform empowering independent artists to build sustainable careers. Though cutting-edge technology and artist 
            ...
            <p className="text-center text-sm lg:text-lg font-bold p-5">As a pioneer in Hiphop Music Distribution and Independent digital music distribution, HoldOnPlay is dedicated to making music accessible while keeping artists in control</p>
